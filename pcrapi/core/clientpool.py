...
from pcrapi.game.model.sdkrequests import ToolSdkLoginRequest
from typing import Dict, Tuple
from ..constants import SESSION_ERROR_MAX_RETRY, CLIENT_POOL_SIZE_MAX, CLIENT_POOL_MAX_AGE, CACHE_DIR, \
    CLIENT_POOL_MAX_CLIENT_ALIVE
...
class PoolClientWrapper(pcrclient):
    ...
    def logged(self) -> eLoginStatus:
        if not self.session._logged:
            ...
            return eLoginStatus.NEED_REFRESH
        else:
