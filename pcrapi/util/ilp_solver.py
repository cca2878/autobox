...
if __name__ == '__main__':
    ...
    memory_use_average(
        [1, 1, 55, 46, 10, 90, 3, 124, 90, 4, 33, 31, 5, 51, 18, 114, 30, 9, 47, 22, 19, 53, 9, 9, 37, 22, 24, 32, 176,
         32, 200, 234, 322, 103, 44, 21, 45, 69, 20, 58, 57, 147, 85, 27, 9, 89, 31, 46, 37, 22, 7, 9, 16, 46, 88, 38,
         16, 33, 15], 3000)
    memory_use_average_binary_search(
        [1, 1, 55, 46, 10, 90, 3, 124, 90, 4, 33, 31, 5, 51, 18, 114, 30, 9, 47, 22, 19, 53, 9, 9, 37, 22, 24, 32, 176,
         32, 200, 234, 322, 103, 44, 21, 45, 69, 20, 58, 57, 147, 85, 27, 9, 89, 31, 46, 37, 22, 7, 9, 16, 46, 88, 38,
         16, 33, 15], 3000)
